      ...
      module V1
        ...
        class ClusterManagerClient
          ...
          def initialize \
            ...
            @start_i_p_rotation = Google::Gax.create_api_call(
              @cluster_manager_stub.method(:start_i_p_rotation),
              defaults["start_i_p_rotation"]
            )
            @complete_i_p_rotation = Google::Gax.create_api_call(
              @cluster_manager_stub.method(:complete_i_p_rotation),
              defaults["complete_i_p_rotation"]
            )
          ...
          #   zone = ''
          #   cluster_id = ''
          #   response = cluster_manager_client.start_i_p_rotation(project_id, zone, cluster_id)
          ...
          def start_i_p_rotation \
            ...
            @start_i_p_rotation.call(req, options)
          end
          ...
          #   zone = ''
          #   cluster_id = ''
          #   response = cluster_manager_client.complete_i_p_rotation(project_id, zone, cluster_id)
          ...
          def complete_i_p_rotation \
            ...
            @complete_i_p_rotation.call(req, options)
          end
